    ...
    <Container maxWidth='lg'>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center' }}>
        ...
        {productsData.map((product, index) => (
          ...
          { matches ? 
            <><Typography variant="h4" paddingBottom={1}>{product.name}</Typography><Box sx={{ display: 'flex', justifyContent: 'center' }}>
                <Box sx={{ width: '80%' }}>
            ...
            : <><Typography variant="h6" paddingBottom={1}>{product.name}</Typography><Box sx={{ display: 'flex', justifyContent: 'center' }}>
                <Box sx={{ width: '80%' }}>
