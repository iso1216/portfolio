    ...
    <Box>
      <Grid container marginY={2}>
        <Grid xs={12} md={4} textAlign='center' paddingTop={1} sx={{display: {xs: "none", md: "block"}}}>
          <Typography fontSize={12} fontWeight={450} component={RouterLink} to={'/'} color={"inherit"} sx={{textDecoration: 'none', letterSpacing: 1 }}>© 2023 Taishi Isomura</Typography>
        </Grid>
        ...
        >
          <Grid sx={{order: { xs: 2, sm: 1 }, display: {xs: "block", md: "none"}}}>
            <Typography fontSize={12} fontWeight={400} component={RouterLink} to={'/'} color={"inherit"} sx={{textDecoration: 'none', letterSpacing: 1}}>© 2023 Taishi Isomura</Typography>
          </Grid>
